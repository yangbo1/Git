...
<html lang="en">
 ...
 <body>
  ...
  <table width="500" border="1" style="border-collapse:collapse;">
	...
	<tr>
		...
		<td><s:textfield id="webquantity" name="order[0].quantity"></s:textfield></td>
	</tr>
	<tr>
		...
		<td><s:textfield id="mathquantity" name="order[1].quantity"></s:textfield></td>
	</tr>
	<tr>
		...
		<td><s:textfield id="osquantity" name="order[2].quantity"></s:textfield></td>
	</tr>
	<tr>
		...
		<td><s:textfield id="matquantity" name="order[3].quantity"></s:textfield></td>
	</tr>
  </table>
  payment method:
 <%-- <input type="radio" name="method" value="cash" checked="checked" />cash
  ...
  <input type="radio" name="method" value="wechat" />wechat<br>--%>
	  <s:radio name="paymehod" list="{'cash','cheque','credit card','wechat'}"></s:radio><br>
	  <s:submit name="submit" type="submit" value="提交"></s:submit>
	  <s:reset name="reset" type="reset" value="重置"></s:reset>
  </s:form>
 <a href="find.jsp">查询页面</a>
  <br><br>
<a href="book2.jsp">到实验二</a>
 </body>
</html>
